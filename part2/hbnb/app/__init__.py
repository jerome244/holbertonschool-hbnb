...
from .models import place    as _place_mod;   sys.modules['place']   = _place_mod
from .models import amenity  as _amenity_mod; sys.modules['amenity'] = _amenity_mod
from .models import user     as _user_mod;    sys.modules['user']    = _user_mod
# alias booking and review so `import booking` / `from booking import Booking` works
import app.models.booking as _bk_mod; sys.modules['booking'] = _bk_mod
import app.models.review  as _rv_mod; sys.modules['review']  = _rv_mod
